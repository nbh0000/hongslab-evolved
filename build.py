...
@keyframes portfolioGlow{0%,100%{box-shadow:0 0 0 4px rgba(168,20,90,.10),0 12px 40px rgba(168,20,90,.35)}50%{box-shadow:0 0 0 8px rgba(168,20,90,.06),0 16px 56px rgba(168,20,90,.55)}}
